        ...
        >
          <div className="flex w-max animate-marquee motion-reduce:animate-none">
            {logos.map((item, i) => (
              <div
                key={`${item.name}-${i}`}
                className="flex shrink-0 select-none items-center gap-2 whitespace-nowrap pr-10 sm:pr-14 text-muted-foreground/50 transition-colors hover:text-muted-foreground"
