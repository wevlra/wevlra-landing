...
export function Pricing() {
  return (
    <Section id="harga" className="relative overflow-x-clip">
      <div
        aria-hidden="true"
        className="pointer-events-none absolute top-0 left-1/2 -z-10 size-[600px] -translate-x-1/2 rounded-full bg-primary/5 blur-3xl"
      />
                  ...
                  >
                    {tier.popular && (
                      <div className="pointer-events-none absolute inset-x-0 -top-3.5 z-20 flex justify-center">
                        <Badge className="pointer-events-auto gap-1.5 border-0 bg-gradient-to-r from-primary to-chart-3 px-3.5 py-1 text-[11px] font-semibold tracking-wide text-primary-foreground uppercase shadow-lg shadow-primary/25">
                    ...
                    <Card
                      className={cn(
                        ...
                        tier.popular
                          ? "border-primary/60 bg-card shadow-2xl ring-1 shadow-primary/15 ring-primary/30 md:scale-[1.02]"
                          : "hover-lift border-border/60 hover:border-border"
                      )}
                    >
                      {tier.popular && (
                        <div
