...
export const testimonials: Testimonial[] = [
  {
    quote:
      "WEVLRA mengubah cara saya berbisnis. Dalam 3 hari, toko online batik saya sudah tayang dan langsung dapat pesanan pertama!",
    name: "Siti Rahayu",
    role: "Pemilik Batik Nusantara, Yogyakarta",
  },
  {
    quote:
      "Saya tidak paham teknologi sama sekali, tapi tim WEVLRA sangat sabar menjelaskan. Website saya sekarang terlihat lebih profesional dari kompetitor.",
    name: "Budi Santoso",
  ...
  {
    quote:
      "Dukungan via WhatsApp sangat membantu. Setiap ada pertanyaan, tim WEVLRA selalu responsif dan ramah.",
    name: "Ahmad Fauzi",
    role: "Manajer Marketing, Klinik Sehat Sentosa",
  },
  {
    quote:
      "Sejak pakai WEVLRA, traffic organik website kami naik 3x lipat dalam 2 bulan. SEO-nya benar-benar bekerja!",
    name: "Linda Wijaya",
